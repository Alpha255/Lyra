 ...
 */
UCLASS()
class LYRAGAME_API ULyraWeaponUserInterface : public UCommonUserWidget
{
	GENERATED_BODY()
...
public:
    ...
    void OnWeaponChanged(class ULyraWeaponInstance* OldWepon, ULyraWeaponInstance* NewWeapon);
